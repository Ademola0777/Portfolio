...
const Contact = () => {
  ...
  return (
    <section id="contact" className="pt-28 lg:pt-36 ">
      <div className="container px-4 mx-auto lg:px-8 xl:max-w-6xl items-center lg:items-stretch lg:grid lg:grid-cols-2 lg:gap-10">
        <div mb-12 lg:mb-0 lg:flex lg:flex-col>
          <h2 className="text-3xl mb-8 lg:text-4xl lg:max-w-[12ch] lg:leading-tight font-semibold bg-linear-[0deg,#fafafa,#a1a1aa] bg-clip-text text-transparent reveal-up">
          ...
          <div className="md:grid md:grid-cols-2 md:gap-2 md:items-center">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="salaudeen@example.com"
                className="text-field reveal-up"
              />
            </div>
            <div className="mb-4 md:inline-block lg:col-span-2">
            ...
            <button
              type="submit"
              className="w-full cursor-pointer reveal-up px-4 rounded-xl font-medium text-sm ring-1 ring-zinc-50/5 ring-inset transition-[background-color] h-11 secondarybg text-zinc-950 hover:bg-sky-300 active:bg-sky-400 "
            >
              Submit
            </button>
          </div>
